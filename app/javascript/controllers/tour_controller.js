...
// Cburnett's black knight (Wikimedia Commons, CC BY-SA 3.0), inlined so its
// fill/drop-shadow can be styled and so it scales with the square via CSS
// instead of relying on how each OS/browser happens to render ♞.
const KNIGHT_SVG = `
